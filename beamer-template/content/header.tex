...
%Titel:
\title{Investigation of the measured signal of protons in pixelated semiconductor detectors}

%Autor
\author[Felix Gläsemann]{Felix Gläsemann}
%Lehrstuhl/Fakultät
\institute[]{TU Dortmund, Department of Physics - AG Kröninger}
