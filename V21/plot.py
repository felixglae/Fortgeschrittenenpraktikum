...
plt.plot(f_fit,lin(f_fit,*params85)*1e6,'b--',label="Fit Rb-87")
plt.plot(f_fit,lin(f_fit,*params87)*1e6,'k--',label="Fit Rb-85")
plt.plot(rf_freq,Bg85*1e6,'bx',label="Erster Peak")
plt.plot(rf_freq,Bg87*1e6,'kx',label="Zweiter Peak")
plt.xlabel(r"$\nu_{RF}\,/\,$kHz")
plt.ylabel(r"$Horizontalkomponente \, B\,/\,\mu$T")
plt.grid()
plt.legend()
